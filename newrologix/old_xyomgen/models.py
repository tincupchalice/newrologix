...
class XProductCategoryMap(models.Model):
    ...
    product = models.ForeignKey(XyomgenProduct, related_name='productmap_product', on_delete=models.CASCADE)
    category = models.ForeignKey(Category, relate_name='productmap_category', on_delete=models.CASCADE)
...
class XProductDefaultDosingMap(models.Model):
    ...
    map_id = models.AutoField(primary_key=True)
    product = models.ForeignKey(XyomgenProduct, related_name='dosingmap_product', on_delete=models.CASCADE)
