    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_phone', models.CharField(blank=True, max_length=10, null=True)),
                ('doctor_email', models.CharField(blank=True, max_length=255, null=True)),
                ('contact1', models.CharField(max_length=255)),
                ('contact1_phone', models.CharField(max_length=10)),
                ('contact1_email', models.EmailField(blank=True, max_length=255, null=True)),
                ('contact2', models.CharField(blank=True, max_length=255, null=True)),
                ('contact2_phone', models.CharField(blank=True, max_length=10, null=True)),
                ('contact2_email', models.EmailField(blank=True, max_length=255, null=True)),
